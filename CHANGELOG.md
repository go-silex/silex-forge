...
- `plugins/silex-forge/skills/forge-publish/SKILL.md` documents `--force-og` and `--desc`, the two flags `publish.sh` advertises in its own usage that the skill never named.
