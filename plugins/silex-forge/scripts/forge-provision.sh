...
step "             Account · Browser Rendering · Edit"
...
note "Browser Rendering · Edit renders the OG thumbnails. The dashboard group keeps that name; Browser Run is the product."
